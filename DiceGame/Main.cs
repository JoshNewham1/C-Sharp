...
namespace DiceGame
{
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e) // When the program has loaded
        {
            ...
            pictureBoxPlayer1.Location = new Point(Int32.Parse(Convert.ToString(Library.GlobalVariables.playerStats.GetValue(1, 4))), Int32.Parse(Convert.ToString(Library.GlobalVariables.playerStats.GetValue(1, 5)))); // Sets player one's location to the default location in the array
            pictureBoxPlayer2.Location = new Point(Int32.Parse(Convert.ToString(Library.GlobalVariables.playerStats.GetValue(2, 4))), Int32.Parse(Convert.ToString(Library.GlobalVariables.playerStats.GetValue(2, 5)))); // Sets player two's location to the default location in the array
        }
